...
$string['confirmremovequestion'] = 'Confirm remove question';
...
$string['msgstatusdisplay'] = 'Status display message';
...
$string['private'] = 'Private';
$string['privates'] = 'Private';
$string['questionenginephase1'] = 'Question Engine Phase 1';
$string['questionenginephase1_help'] = 'Enable Question Engine Phase 1 infrastructure';
$string['reassess'] = 'Reassess';
$string['remove'] = 'Remove';
$string['removenotes'] = 'Remove notes';
$string['result'] = 'Result';
...
$string['showmore'] = 'Show more';
$string['state'] = 'State';
$string['strattempttitle'] = 'Attempt title: {$a}';
